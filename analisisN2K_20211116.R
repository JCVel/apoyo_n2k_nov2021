...
#########################
### Inclusión de los cruces n2k con APIs no incluidas en BD RNATURA_AnalisisProximidad.mdb
#########################
cruceAPIs_pibal <- st_read(dsn = "D:/JCV_interno/19_n2k_apoyoNov2021/1_datosSalida/cruce_n2k_APIext2.gdb", layer = "polyNeigh_pibal")
cruceAPIs_can <- st_read(dsn = "D:/JCV_interno/19_n2k_apoyoNov2021/1_datosSalida/cruce_n2k_APIext2.gdb", layer = "polyNeigh_can")
...
# AQUIIIII Hay que meter cruceAPIS en RNProxi
