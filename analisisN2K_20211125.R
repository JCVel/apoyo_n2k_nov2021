...
DD_src$IP <- ifelse(DD_src$SITE_PG_NAME == "No hay Instrumentos de Planificación registrados para este espacio RN2000", "no tienen IP", "tienen IP")

#########################
# Instrumentos planificación (IP_nbr)
#########################
...
DD_nbr$IP <- ifelse(DD_nbr$SITE_CODE %in% IP_nbr_tieneIPVector, "con IP", "sin IP")
rm(IP_nbr_tieneIP, IP_nbr_tieneIPVector)
# Cambiar el campo jerar1 para el informe "resumenPorAC_IP" de Access
DD_nbr$jerar1Access <-  paste0(DD_nbr$jerar1, ", ")
DD_nbr[DD_nbr$SITE_CODE == "Sin solape/colindancia con EP", c("jerar1Access")] <- "" 
