...
# Además: Muchas superficies RN2000 están mal... Los casos más extremos son por defecto. P.ej:
...
# En base a lo anterior, se decide:
# - Usar las superfices oficiales del CNTRYES (implica cambiar los datos del campo srcArea)
# - Recalcular el campo AREA en base a 
