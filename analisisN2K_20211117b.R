...
RNProxiAct$LENGTH <- RNProxiAct$AREA / 1000
...
nbr_planes$id <- paste0("pg_", seq(1, nrow(nbr_planes)))
...
var_list <- list(
  sheets = c("EPAct", "RNProxiAct", "RNProxiActMerge", "DD_src", "DD_nbr", "nbr_planes"),
  objects = list(EPAct, RNProxiAct, RNProxiActMerge, DD_src, DD_nbr, nbr_planes)
)
